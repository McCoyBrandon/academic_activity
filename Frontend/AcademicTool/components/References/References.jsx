...
const References = () => {
    ...
    return (
        <ProjectsPageDiv>
            ...
            <DashboardContainer>
                {[
                    { title: 'Add new Reference into Project', img: projectCreate, path: '/projects/viewProjects/reference/create' },
                    { title: 'View Project References', img: projectView, path: '/projects/viewProjects/reference/view' },
